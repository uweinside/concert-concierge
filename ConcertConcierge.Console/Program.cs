...
var agentResponse = client.Administration.CreateAgent(
    ...
    {
        searchEventsTool,                      // ⭐ Custom tool: Ticketmaster API search
        new CodeInterpreterToolDefinition()    // ⭐ Built-in tool: Python code execution sandbox
    }
);
            ...
            if (latestMessage != null && latestMessage.Role.ToString() == "assistant")
            {
                ...
                foreach (var content in latestMessage.ContentItems)
                {
                    ...
                    if (content is MessageTextContent textContent)
                    {
                        ...
                        // Example: Agent creates a PDF → annotation contains file reference
